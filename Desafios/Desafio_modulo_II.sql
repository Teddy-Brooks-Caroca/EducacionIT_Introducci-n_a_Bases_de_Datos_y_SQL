...
-- 3. Crear una tabla con el nombre “AGENDA” dentro de la base de datos, con la estructura 
...
-- 5. Visualizar las tablas existentes en la base de datos para verificar la creación de la tabla 
--    “AGENDA”.
...
INSERT INTO AGENDA
VALUES 
(1, 'LUCIANO', 'FERNANDEZ', 'MARTIN RODRIGUEZ 1271', 1156485201, 'L.FERNANDEZ@GMAIL.COM'),
...
-- 1. Crear una base de datos con el nombre “LIBRERÍA”. Poner en uso la base de datos 
--    generada. Debe estar conformada por 8 tablas con la estructura que se muestra en la 
...
-- 2. Una vez creadas todas las tablas, insertar un conjunto de registros en cada una de ellas, 
--    utilizando el archivo con el nombre “SCRIPT”. 
...
-- 1. A partir de lo realizado en el Ejercicio 2, luego de insertar los registros, definir las claves 
--    primarias (primary key) en cada tabla. Tener en cuenta que cada tabla tiene un campo con 
--    el sufijo _id que identifica al campo clave. 
...
-- 2. Examinar los datos ingresados, e insertar 3 registros en cada una de las tablas utilizando 
--    la sentencia INSERT del conjunto de sentencias DML (Data Manipulation Language) del lenguaje SQL.

INSERT INTO autores VALUES
('901-11-2233','Márquez','Gabriel','45112233','','Aracataca','CO','11001',1),
('902-22-3344','Allende','Isabel','45223344','','Lima','PE','15001',1),
('903-33-4455','Bolaño','Roberto','45334455','','Santiago','CL','83200',0);

INSERT INTO editoriales VALUES
('2001','Penguin Random House','Madrid','MD','España'),
('2002','Anagrama','Barcelona','BC','España'),
('2003','Siglo XXI','México DF','DF','México');

INSERT INTO puestos VALUES
(15,'Corrector de Estilo'),
(16,'Maquetador Editorial'),
(17,'Analista de Ventas');

INSERT INTO locales VALUES
('9001','Librería Central','Av Callao 321','Buenos Aires','CF','1010'),
('9002','Librería Norte','Belgrano 455','Salta','SA','4400'),
('9003','Librería Sur','Mitre 899','Ushuaia','TF','9410');

INSERT INTO libros VALUES
('NX1001','Cien años de soledad','Novelas','2001',25.50,'','1967-05-30 00:00:00'),
('NX1002','La casa de los espíritus','Novelas','2002',23.90,'','1982-01-01 00:00:00'),
('NX1003','Los detectives salvajes','Novelas','2003',27.80,'','1998-03-01 00:00:00');
...
INSERT INTO empleados VALUES
('EMP90001','Lucía','Morales',15,'2001','2015-04-10 00:00:00'),
('EMP90002','Diego','Suárez',16,'2002','2017-08-21 00:00:00'),
('EMP90003','Valentina','Ríos',17,'2003','2019-11-05 00:00:00');

INSERT INTO ventas VALUES
('9001','10001','2022-06-15 00:00:00',12,'Efectivo','NX1001'),
('9002','10002','2022-07-03 00:00:00',8,'Cheque','NX1002'),
('9003','10003','2022-08-19 00:00:00',5,'Transf','NX1003');
...
-- [TABLE DATA IMPORT WIZARD -> FILE PATH -> SELECT DESTINATION -> CONFIGURE IMPORT SETTING -> IMPORT DATA -> FINISH]
...
-- 3. En el resultado de la consulta, solo se deben observar las columnas ARTISTA, TÍTULO y GÉNERO.
...
-- 1. Con base en el ejercicio anterior, mostrar todos los registros de la tabla TOP_SPOTIFY.
...
-- 2. Mostrar canciones desde la posición 11 hasta la 15 inclusive.
...
-- 3. Obtener canciones de Madonna.
...
-- 4. Obtener canciones del género Pop.
...
-- 6. Canciones anteriores a 2011 del género Dance Pop.

SELECT TITULO 
FROM top_spotify 
WHERE GENERO = 'Pop' AND ANO < 2011 
ORDER BY TITULO;


/* =====================================================
   FIN DESAFÍO MÓDULO II
   ===================================================== */
